...
impl QuestService {
    pub fn new(pool: Pool<Sqlite>) -> Self {
        QuestService { db_pool: pool }
    }

    pub async fn get_quests_by_mission_data(
        &self,
        campaign_number: u32,
        mission_number: u32,
    ) -> Result<Vec<QuestDBModel>, sqlx::Error> {
        let quests: Result<Vec<QuestDBModel>, sqlx::Error> = sqlx::query_as(
            r#"
    ...
    pub async fn is_secondary_quest(&self, quest_id: Uuid) -> Result<bool, sqlx::Error> {
        let is_secondary: (bool,) = sqlx::query_as(
            r#"
    ...
    pub async fn update_quest_directory(
        ...
        let _res: QuestDBModel = sqlx::query_as(
            r#"
                UPDATE quests 
                SET directory=?
                WHERE id=?
    ...
    pub async fn update_quest_is_active(
        &self,
        quest_id: Uuid,
        new_is_active: bool,
    ) -> Result<(), sqlx::Error> {
    ...
    pub async fn update_quest_is_secondary(
        &self,
        quest_id: Uuid,
        new_is_secondary: bool,
    ) -> Result<(), sqlx::Error> {
        let _res: QuestDBModel = sqlx::query_as(
            r#"
                UPDATE quests 
    ...
    pub async fn get_quest_progress(
        ...
        quest_id: Uuid,
        progress_number: u32,
    ) -> Result<QuestProgressDBModel, sqlx::Error> {
        let existing_progress: Option<QuestProgressDBModel> = sqlx::query_as(
            r#"
    ...
    pub async fn save_progress(
        ...
        let _progress_update_result: QuestProgressDBModel = sqlx::query_as(
            r#"
                UPDATE progresses 
                SET text=?
    ...
    pub async fn update_progress_concatenation(
        ...
        let _update_result: QuestProgressDBModel = sqlx::query_as(
            r#"
                UPDATE progresses
                SET concatenate=?
                WHERE quest_id=? AND number=?
    ...
    pub async fn add_quest_to_queue(&self, quest_id: Uuid, map_id: u16) -> Result<(), sqlx::Error> {
        let _quest_add_result = sqlx::query(
            r#"
    ...
    pub async fn get_quests_to_apply(&self, map_id: u16) -> Result<Vec<QuestDBModel>, sqlx::Error> {
        let quests: Vec<QuestDBModel> = sqlx::query_as(
            r#"
                SELECT * FROM quests 
                WHERE id IN
    ...
    pub async fn get_quest_progresses(
        &self,
        quest_id: Uuid,
    ) -> Result<Vec<QuestProgressDBModel>, sqlx::Error> {
        let progresses: Vec<QuestProgressDBModel> = sqlx::query_as(
            r#"
    ...
    pub async fn delete_quests_from_queue(&self, map_id: u16) -> Result<(), sqlx::Error> {
        let _queue_deletion_result = sqlx::query(
            r#"
