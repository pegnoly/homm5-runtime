...
pub async fn add_reserve_hero(
    ...
    let new_hero = AdvMapHero {
        ...
        experience: 0,
        army_slots: ArmySlots {army_slots: None},
        artifact_ids: ArtifactIds { items: None},
        is_untransferable: IsUntransferable {items: None},
        editable: Editable {
            NameFileRef: None,
            ...
            Spellpower: 0,
            Knowledge: 0,
            skills: Skills {items: None},
            perkIDs: Perks {items: None},
            spellIDs: SpellIds {items: None},
            Ballista: false,
            FirstAidTent: false,
            AmmoCart: false,
            FavoriteEnemies: FavoriteEnemies {items: None},
