use crate::{
    entity::{CollectFiles, Output, Scan, configure_path},
    output::OutputJson,
    pak::FileStructure,
};
...
impl Output for AdvMapHeroShared {
    ...
    fn to_lua(&self, _id: &Option<String>) -> String {
        ...
        bio = \"{}\"
            ...
            self.Class,
            self.Specialization,
            self.SpecializationNameFileRef
                .as_ref()
                .unwrap()
                .href
                .as_ref()
                .unwrap_or(&String::new()),
            self.SpecializationDescFileRef
                .as_ref()
                .unwrap()
                .href
                .as_ref()
                .unwrap_or(&String::new()),
            self.SpecializationIcon
                .as_ref()
                .unwrap()
                .href
                .as_ref()
...
impl Scan<String> for HeroScaner {
    fn scan(
        ...
        entity: &String,
        files: &HashMap<String, FileStructure>,
    ) -> Option<Box<dyn Output<ID = String>>> {
        let mut buf = Vec::new();
